...
```
PASS  Plugins\Zrm\Hr\tests\Feature\PayrollIntegrationTest
...
2. ✅ Plugin Autoloader - `composer dump-autoload` fixed, Zrm\Hr namespace now autoloadable  
...
# Initial setup:
php artisan db:seed
php artisan db:seed --class="Zrm\Hr\Database\Seeders\DatabaseSeeder"
...
php artisan db:seed --class="Zrm\Hr\Database\Seeders\HrDemoSeeder"
```
...
- [x] `plugins/zrm/hr/src/Filament/Company/Resources/Hr/PayrollEntryResource.php` - Added Bill tracking UI
