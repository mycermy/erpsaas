...
class InventoryDatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        CompanyDefault::updateOrCreate(
            ['company_id' => $this->company->id],
            ['currency_code' => 'MYR']
        );

        CompanySettingsService::invalidateSettings($this->company->id);
    ...
    private function createWarehouse(): Warehouse
    {
        $warehouse1 = Warehouse::firstOrCreate(
            ...
            [
                'name' => 'Warehouse Bertam',
                'address' => 'Sebelah MyDin Bertam',
                'city' => 'Bandar Bertam Putra',
                'state' => 'Pulau Pinang',
                'postal_code' => '13200',
                'country' => 'MYS',
                'contact_name' => 'Mang Manager',
                'contact_phone' => '+60-5550100',
                'contact_email' => 'warehouse.bertam@mngqualityauto.test',
                'is_default' => true,
                'active' => true,
        ...
        $this->command->info("  Created/Found warehouse: {$warehouse1->name}");
        ...
        $warehouse2 = Warehouse::firstOrCreate(
            ...
            [
                'name' => 'Warehouse Kepala Batas',
                'address' => 'Permatang Manggis',
                'city' => 'Kepala Batas',
                'state' => 'Pulau Pinang',
                'postal_code' => '13200',
                'country' => 'MYS',
                'contact_name' => 'Johan Manager',
                'contact_phone' => '+60-5550101',
                'contact_email' => 'warehouse.kepala_batas@mngqualityauto.test',
                'is_default' => false,
                'active' => true,
                'created_by' => $this->company->owner->id,
            ]
        ...
        $this->command->info("  Created/Found warehouse: {$warehouse2->name}");
    ...
    private function createSalesInvoices(array $offerings, array $clients, Warehouse $warehouse): void
    {
        ...
        foreach (range(1, 3) as $invoiceIndex) {
            ...
            foreach ($selectedOfferings as $offeringData) {
                ...
                $stockLevel = InventoryStockLevel::where('inventory_item_id', $inventoryItem->id)
