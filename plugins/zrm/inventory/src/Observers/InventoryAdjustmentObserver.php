...
class InventoryAdjustmentObserver
{
    ...
    protected function processInventoryAdjustment(InventoryAdjustment $adjustment): void
    {
        ...
        $items = InventoryAdjustmentItem::withoutGlobalScope(\App\Scopes\CurrentCompanyScope::class)
        ...
        foreach ($adjustment->items as $adjustmentItem) {
            ...
            $inventoryItem = InventoryItem::withoutGlobalScope(\App\Scopes\CurrentCompanyScope::class)->find($adjustmentItem->inventory_item_id);
    ...
    protected function createAccountingTransaction(InventoryAdjustment $adjustment): void
    {
        ...
        foreach ($items as $item) {
            ...
            if ($unitCost == 0 && $quantity != 0) {
                $movement = InventoryMovement::withoutGlobalScope(\App\Scopes\CurrentCompanyScope::class)
