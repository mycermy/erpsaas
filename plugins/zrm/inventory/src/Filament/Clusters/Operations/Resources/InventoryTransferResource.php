...
use Zrm\Inventory\Enums\TransferStatus;
use Zrm\Inventory\Filament\Clusters\Operations\Resources\InventoryTransferResource\Pages;
use Zrm\Inventory\Models\InventoryTransfer;
                ...
                Forms\Components\Section::make('Transfer Information')
                    ->schema([
                        ...
                        Forms\Components\Select::make('from_warehouse_id')
                            ...
                            ->preload()
                            ->disabled(
                                fn(?string $operation, ?InventoryTransfer $record) =>
                    ...
                    ->action(function (InventoryTransfer $record) {
                        ...
                        foreach ($record->items as $item) {
                            ...
                            $inventoryService->recordMovement(
                                ...
                                movementType: \Zrm\Inventory\Enums\MovementType::TransferOut,
                                unitCost: 0,
                            ...
                            $inventoryService->recordMovement(
                                ...
                                quantity: $item->quantity,
                                movementType: \Zrm\Inventory\Enums\MovementType::TransferIn,
                                unitCost: 0,
                                referenceType: InventoryTransfer::class,
                                referenceId: $record->id,
                                movementDate: $record->transfer_date
