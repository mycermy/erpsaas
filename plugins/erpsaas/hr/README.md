...
It is packaged here as a standalone Filament plugin under `plugins/erpsaas/hr/`, following the same conventions as the existing `erpsaas/accounts` and `erpsaas/core` plugins.
