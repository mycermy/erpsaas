...
All classes live under `Erpsaas\Hr\*`. Cross-plugin references use the following resolved namespaces:
...
| `App\Enums\Hr\SalaryPartBasis` | `Erpsaas\Hr\Enums\Hr\SalaryPartBasis` |
| `App\Enums\Hr\SalaryPartType` | `Erpsaas\Hr\Enums\Hr\SalaryPartType` |
| `App\Models\Hr\*` | `Erpsaas\Hr\Models\*` |
| `App\Filament\Company\Resources\Hr\*` | `Erpsaas\Hr\Filament\Company\Resources\Hr\*` |
