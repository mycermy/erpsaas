...
<div x-data="panelShiftDropdown" x-on:click.outside="closeDropdown">
    ...
    <div
        x-show="open"
        class="flex flex-col transition duration-200 ease-in-out grow shrink top-16 fixed z-10 w-screen max-w-sm end-4 sm:end-8 rounded-lg bg-white shadow-lg ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 overflow-hidden"
    >
