...
**📋 Quick Reference**: Check [local attributes list](../../docs/laravel-attributes.md) to see what's available.

**📖 Detailed Docs (Offline)**: For namespaces and full examples, see [local attributes directory](../../docs/attributes/) - **87 markdown files** with complete documentation.

Always include the `use` import — attributes do nothing without it.

**Note for Laravel 12**: Some attributes are available (marked in the reference), but most require Laravel 13+. Use traditional properties for unsupported features.
