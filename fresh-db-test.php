...
try {
    ...
    echo "   • Sold: {$oversellQty} units (allowed negative)\n";
    echo "   • Purchased: {$restockQty} units\n";
    echo "   • Final stock: {$stockAfterBill} units\n";
    echo '   • Expected: ' . ($initialStock - $oversellQty + $restockQty) . " units\n\n";

    echo "✅ System Features Verified:\n";
    echo "   ✓ Invoice flagging on overselling\n";
    echo "   ✓ Automatic unflagging on restock\n";
    echo "   ✓ Observer-based processing (no manual triggers)\n";
    echo "   ✓ Batch tracking working correctly\n";
    echo "   ✓ Negative inventory allowed (soft block)\n\n";
