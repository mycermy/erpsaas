                            ...
                            ->schema([
                                Forms\Components\Select::make('inventory_item_id')
                                    ...
                                    ->getSearchResultsUsing(function (?string $search) {
                                        ...
                                        $query = \Modules\Inventory\Models\InventoryItem::with('offering')
                                    ...
                                    ->getOptionLabelUsing(function (?int $value): ?string {
                                        ...
                                        $item = \Modules\Inventory\Models\InventoryItem::with('offering')
                                            ->when($companyId, fn($q) => $q->where('company_id', $companyId))
                                            ->find($value);
                                    ...
                                    ->schema([
                                        Forms\Components\Select::make('inventory_batch_id')
                                            ...
                                            ->options(function (Get $get) {
                                                ...
                                                return \Modules\Inventory\Models\InventoryBatch::where('inventory_item_id', $itemId)
                                                    ->where('warehouse_id', $warehouseId)
                                            ...
                                            ->afterStateUpdated(function (Forms\Set $set, ?int $state, Get $get) {
                                                ...
                                                $batch = \Modules\Inventory\Models\InventoryBatch::find($state);
                                                if ($batch) {
                                        ...
                                        Forms\Components\TextInput::make('quantity')
                                            ...
                                            ->maxValue(function (Get $get) {
                                                ...
                                                $batch = \Modules\Inventory\Models\InventoryBatch::find($batchId);
                                                if (! $batch) {
                                                    return null;
                                                }
