                ...
                Tables\Actions\Action::make('view_reference')
                    ...
                    ->url(function ($record) {
                        ...
                        return match ($type) {
                            ...
                            'InventoryAdjustment' => \Modules\Inventory\Filament\Resources\InventoryAdjustmentResource::getUrl('edit', [
                                'record' => $record->reference_id,
                                'tenant' => filament()->getTenant(),
                            ]),
                            'InventoryTransfer' => \Modules\Inventory\Filament\Resources\InventoryTransferResource::getUrl('edit', [
                                'record' => $record->reference_id,
                                'tenant' => filament()->getTenant(),
                            ]),
                            default => null,
